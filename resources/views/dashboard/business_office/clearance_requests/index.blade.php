<x-master-layout 
    ...
    footer="dashboard.business_office.partials.footer">

    <div class="container mt-4">
        <h2 class="mb-4 fw-bold">Financial Clearance Requests</h2>
        ...
        @if ($requests->isEmpty())
            <div class="alert alert-info">No financial clearance requests found.</div>
        @else
                            ...
                            @foreach ($requests as $key => $req)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <form action="{{ route('business_office.clearances.hold', $req->id) }}" method="POST" class="d-inline">
                                            @csrf
